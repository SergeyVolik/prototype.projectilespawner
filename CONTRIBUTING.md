...
1. Make an [Issue](https://github.com/sv/prototype.projectilespawner/issues/new)
...
```json
    {
        "dependencies": {
            "com.sv.prototype.projectilespawner": "https://github.com/YOUR_USER/prototype.projectilespawner.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at volik.sergey112@gmail.com.
